...
def plot_projection_beta_sweep(rho_projection_series, task_alpha, bold_alpha, beta_alpha, output_path, series_label=None, trial_indices=None):
    ...
    for idx, (rho_value, projection) in enumerate(sorted_series):
        ...
        if trial_indices_array is not None:
            ...
            axis_values = np.arange(y_trials.size)
        variability_label = f"rho={rho_value:g} (cv={cv_val})"
